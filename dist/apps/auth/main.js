...
/***/ "./apps/auth/src/users/constants/services.ts":
/*!***************************************************!*\
  !*** ./apps/auth/src/users/constants/services.ts ***!
  \***************************************************/
...
/***/ "./apps/auth/src/users/dto/update-user.request.ts":
/*!********************************************************!*\
  !*** ./apps/auth/src/users/dto/update-user.request.ts ***!
  \********************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const update_user_request_1 = __webpack_require__(/*! ./dto/update-user.request */ "./apps/auth/src/users/dto/update-user.request.ts");
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, typeof (_c = typeof update_user_request_1.UpdateUserRequest !== "undefined" && update_user_request_1.UpdateUserRequest) === "function" ? _c : Object]),
    __metadata("design:returntype", Promise)
...
const services_1 = __webpack_require__(/*! ./constants/services */ "./apps/auth/src/users/constants/services.ts");
const microservices_1 = __webpack_require__(/*! @nestjs/microservices */ "@nestjs/microservices");
let UsersService = class UsersService {
    constructor(usersRepository, productsClient) {
    ...
    async updateUser(userId, updateData) {
        const updatedUser = await this.usersRepository.findOneAndUpdate({ _id: userId }, updateData);
        await (0, rxjs_1.lastValueFrom)(this.productsClient.emit("user_updated", {
            updatedUser,
        }));
        return updatedUser;
    }
...
UsersService = __decorate([
    ...
    __metadata("design:paramtypes", [typeof (_a = typeof users_repository_1.UsersRepository !== "undefined" && users_repository_1.UsersRepository) === "function" ? _a : Object, typeof (_b = typeof microservices_1.ClientProxy !== "undefined" && microservices_1.ClientProxy) === "function" ? _b : Object])
], UsersService);
