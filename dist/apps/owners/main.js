...
/***/ "./apps/owners/src/constants/services.ts":
/*!***********************************************!*\
  !*** ./apps/owners/src/constants/services.ts ***!
  \***********************************************/
...
exports.PRODUCT_SERVICE = "PRODUCT";


/***/ }),

/***/ "./apps/owners/src/dto/create-owner.request.ts":
/*!*****************************************************!*\
  !*** ./apps/owners/src/dto/create-owner.request.ts ***!
  \*****************************************************/
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.CreateOwnerRequest = void 0;
...
], CreateOwnerRequest.prototype, "name", void 0);
__decorate([
    (0, class_validator_1.IsEmail)(),
    __metadata("design:type", String)
], CreateOwnerRequest.prototype, "email", void 0);
__decorate([
    (0, class_validator_1.IsPhoneNumber)(),
    __metadata("design:type", String)
], CreateOwnerRequest.prototype, "phoneNumber", void 0);
__decorate([
    (0, class_validator_1.IsString)(),
    __metadata("design:type", String)
], CreateOwnerRequest.prototype, "address", void 0);
exports.CreateOwnerRequest = CreateOwnerRequest;


/***/ }),

/***/ "./apps/owners/src/owners.controller.ts":
/*!**********************************************!*\
  !*** ./apps/owners/src/owners.controller.ts ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const owners_service_1 = __webpack_require__(/*! ./owners.service */ "./apps/owners/src/owners.service.ts");
const create_owner_request_1 = __webpack_require__(/*! ./dto/create-owner.request */ "./apps/owners/src/dto/create-owner.request.ts");
let OwnersController = class OwnersController {
    constructor(ownersService) {
        this.ownersService = ownersService;
    }
    async createOwner(request, req) {
        var _a;
        return this.ownersService.createOwner(request, (_a = req.cookies) === null || _a === void 0 ? void 0 : _a.Authentication);
    }
    async updateOwner(request, req) {
        var _a;
        return this.ownersService.createOwner(request, (_a = req.cookies) === null || _a === void 0 ? void 0 : _a.Authentication);
    }
    async getOwnerById(orderId) {
...
__decorate([
    ...
    __metadata("design:paramtypes", [typeof (_b = typeof create_owner_request_1.CreateOwnerRequest !== "undefined" && create_owner_request_1.CreateOwnerRequest) === "function" ? _b : Object, Object]),
...
__decorate([
    ...
    __param(1, (0, common_1.Req)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [typeof (_c = typeof create_owner_request_1.CreateOwnerRequest !== "undefined" && create_owner_request_1.CreateOwnerRequest) === "function" ? _c : Object, Object]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:returntype", Promise)
], OwnersController.prototype, "getOwnerById", null);
OwnersController = __decorate([
    (0, common_1.Controller)("owners"),
    __metadata("design:paramtypes", [typeof (_a = typeof owners_service_1.OwnersService !== "undefined" && owners_service_1.OwnersService) === "function" ? _a : Object])
], OwnersController);
...
/***/ "./apps/owners/src/owners.module.ts":
/*!******************************************!*\
  !*** ./apps/owners/src/owners.module.ts ***!
  \******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const owners_controller_1 = __webpack_require__(/*! ./owners.controller */ "./apps/owners/src/owners.controller.ts");
const owners_service_1 = __webpack_require__(/*! ./owners.service */ "./apps/owners/src/owners.service.ts");
const services_1 = __webpack_require__(/*! ./constants/services */ "./apps/owners/src/constants/services.ts");
const common_2 = __webpack_require__(/*! @app/common */ "./libs/common/src/index.ts");
const mongoose_1 = __webpack_require__(/*! @nestjs/mongoose */ "@nestjs/mongoose");
const owner_schema_1 = __webpack_require__(/*! ./schemas/owner.schema */ "./apps/owners/src/schemas/owner.schema.ts");
const config_1 = __webpack_require__(/*! @nestjs/config */ "@nestjs/config");
const Joi = __webpack_require__(/*! joi */ "joi");
const owners_repository_1 = __webpack_require__(/*! ./owners.repository */ "./apps/owners/src/owners.repository.ts");
    ...
    (0, common_1.Module)({
        imports: [
            ...
            common_2.RmqModule.register({
                name: services_1.PRODUCT_SERVICE,
            }),
        ...
        providers: [owners_service_1.OwnersService, owners_repository_1.OwnersRepository],
    })
], OwnersModule);
...
/***/ "./apps/owners/src/owners.repository.ts":
/*!**********************************************!*\
  !*** ./apps/owners/src/owners.repository.ts ***!
  \**********************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
var OwnersRepository_1;
var _a, _b;
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.OwnersRepository = void 0;
const common_1 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const common_2 = __webpack_require__(/*! @app/common */ "./libs/common/src/index.ts");
const mongoose_1 = __webpack_require__(/*! @nestjs/mongoose */ "@nestjs/mongoose");
const mongoose_2 = __webpack_require__(/*! mongoose */ "mongoose");
const owner_schema_1 = __webpack_require__(/*! ./schemas/owner.schema */ "./apps/owners/src/schemas/owner.schema.ts");
let OwnersRepository = OwnersRepository_1 = class OwnersRepository extends common_2.AbstractRepository {
    constructor(ownerModel, connection) {
        super(ownerModel, connection);
        this.logger = new common_1.Logger(OwnersRepository_1.name);
    }
};
OwnersRepository = OwnersRepository_1 = __decorate([
...
/***/ "./apps/owners/src/owners.service.ts":
/*!*******************************************!*\
  !*** ./apps/owners/src/owners.service.ts ***!
  \*******************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
let OwnersService = class OwnersService {
    constructor(ownersRepository, productClient) {
        this.ownersRepository = ownersRepository;
        this.productClient = productClient;
    }
    async createOwner(request, authentication) {
    ...
    async updateOwner(id, request, authentication) {
        const session = await this.ownersRepository.startTransaction();
        try {
            const owner = await this.ownersRepository.findOneAndUpdate({ _id: id }, request);
            if (owner) {
                await (0, rxjs_1.lastValueFrom)(this.productClient.emit("owner_updated", {
                    id,
                    request,
...
OwnersService = __decorate([
    (0, common_1.Injectable)(),
    __param(1, (0, common_1.Inject)(services_1.PRODUCT_SERVICE)),
    __metadata("design:paramtypes", [typeof (_a = typeof owners_repository_1.OwnersRepository !== "undefined" && owners_repository_1.OwnersRepository) === "function" ? _a : Object, typeof (_b = typeof microservices_1.ClientProxy !== "undefined" && microservices_1.ClientProxy) === "function" ? _b : Object])
], OwnersService);
...
/***/ "./apps/owners/src/schemas/owner.schema.ts":
/*!*************************************************!*\
  !*** ./apps/owners/src/schemas/owner.schema.ts ***!
  \*************************************************/
/***/ (function(__unused_webpack_module, exports, __webpack_require__) {
...
const mongoose_2 = __webpack_require__(/*! mongoose */ "mongoose");
let Owner = class Owner extends common_1.AbstractDocument {
};
__decorate([
    (0, mongoose_1.Prop)(),
    __metadata("design:type", String)
...
/*!*********************************!*\
  !*** ./apps/owners/src/main.ts ***!
  \*********************************/

Object.defineProperty(exports, "__esModule", ({ value: true }));
const core_1 = __webpack_require__(/*! @nestjs/core */ "@nestjs/core");
const owners_module_1 = __webpack_require__(/*! ./owners.module */ "./apps/owners/src/owners.module.ts");
const common_1 = __webpack_require__(/*! @app/common */ "./libs/common/src/index.ts");
const common_2 = __webpack_require__(/*! @nestjs/common */ "@nestjs/common");
const config_1 = __webpack_require__(/*! @nestjs/config */ "@nestjs/config");
async function bootstrap() {
    const app = await core_1.NestFactory.create(owners_module_1.OwnersModule);
    const rmqService = app.get(common_1.RmqService);
    app.connectMicroservice(rmqService.getOptions("OWNERS"));
